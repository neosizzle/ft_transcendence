...
const SearchSection: FunctionComponent<SearchSectionProps> = ({
	...
	return ( 
		<div className="w-full">
			<SearchBar setSearchInput={setSearchInput} loading={searchLoading} label="Search"/>
			<div className="w-full my-2">
				<div className="flex justify-center">
					<div className="flex w-10/12">
						<Dropdown label="Filters" openDropdown={openFilterDropdown} setOpenDropdown = {setOpenFilterDropdown}><FilterMenu filter={filter} setFilter={setFilter}/></Dropdown>
						<Dropdown label="Sort" openDropdown={openSortDropdown} setOpenDropdown = {setOpenSortDropdown}><SortMenu sort={sort} setSort={setSort}/></Dropdown>
					</div>
				</div>
