...
export class BucketController {
  ...
  @Post()
  uploadFile(@Req() req: customReq, @UploadedFile() file: Express.Multer.File) {
    if (!file || req.fileError)
      throw new BadRequestException(req.fileError ? req.fileError : "Bad file");
